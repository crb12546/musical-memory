...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-6 py-4 text-left align-middle font-semibold text-gray-900 bg-gray-50 first:rounded-tl-lg last:rounded-tr-lg [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-6 py-4 align-middle text-gray-700 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
